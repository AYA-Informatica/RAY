...
export const NEIGHBORHOODS_BY_DISTRICT: Record<KigaliDistrict, Neighborhood[]> = {
  Gasabo: KIGALI_NEIGHBORHOODS.filter((n) => n.district === 'Gasabo'),
  Kicukiro: KIGALI_NEIGHBORHOODS.filter((n) => n.district === 'Kicukiro'),
  Nyarugenge: KIGALI_NEIGHBORHOODS.filter((n) => n.district === 'Nyarugenge'),
}
