...
CREATE INDEX IF NOT EXISTS "Conversation_buyerId_updatedAt_idx"
  ON public."Conversation" ("buyerId", "updatedAt" DESC);

CREATE INDEX IF NOT EXISTS "Conversation_sellerId_updatedAt_idx"
...
CREATE INDEX IF NOT EXISTS "Message_conversationId_isRead_senderId_idx"
